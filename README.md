...
## Git and Docker
- [Intro to Git & GitHub](resources/INTRO_TO_GIT_&_GITHUB.md)
...
- [Tutorial](https://docs.ros.org/en/humble/Tutorials.html)
- [Tutorial (from robotics backend)](https://roboticsbackend.com/category/ros2/)

## C++
- Make sure you understand C++ fundamentals, including inheritance, smart pointers, and lambda functions.
